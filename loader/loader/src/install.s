...
.endif; !GENERIC_INSTALL
            ...
            ; in:  a/x - if LOAD_ONCE, lo/hi to 0-terminated filename string
            ; out: c - set on error
            ;      a - status
...
:           stx FA
            ...
            ; more than 1 drive on the bus or generic devices present
            sta FA
            jsr UNLSTN

    .if LOAD_ONCE && LOAD_VIA_KERNAL_FALLBACK
            jsr openfile; we can still load
    .endif
            plp; i-flag restore
...
:           sta c1570fix0 - cbm1571::drvcodebeg + cbm1571::drivecode71
            sta c1570fix1 - cbm1571::drvcodebeg + cbm1571::drivecode71
            sta c1570fix2 - cbm1571::drvcodebeg + cbm1571::drivecode71
            stx c1570fix3 - cbm1571::drvcodebeg + cbm1571::drivecode71
            stx c1570fix4 - cbm1571::drvcodebeg + cbm1571::drivecode71

is1581:
selectdcod: sty drivetype + $01
            ldx dcodeseltb - diskio::drivetypes::DRIVE_1541,y
            lda dcodeselt0,x
            sta dcodesel0
            lda dcodeselt1,x
            sta dcodesel1
...
:           cmp VIC2_RASTERLINE; the timer is started at the approximate beginning of a raster line
            bne :-
            lda #.lobyte(CYCLES_PER_LINE_PAL * 8 - $01); timing interval is 8 scanlines XXX TODO NTSC: user-supplied flag or check?
            sta CIA2_TA_LO
...
dcodeseltb: .byte diskio::drivetypes::DRIVES_1541,diskio::drivetypes::DRIVES_1541,diskio::drivetypes::DRIVES_1541; drivecode1541 for 1541, 1541-C, 1541-II
            .byte diskio::drivetypes::DRIVES_157X,diskio::drivetypes::DRIVES_157X                                ; drivecode1571 for 1570, 1571
            .byte diskio::drivetypes::DRIVES_1581_CMD                                                            ; drivecode1581 for 1581

dcodeselt0: .byte <(cbm1541::dinstall  - cbm1541::drvcodebeg41 + cbm1541::drivecode41)
            .byte <(cbm1571::drivebusy - cbm1571::drvcodebeg + cbm1571::drivecode71)
            .byte <(cbm1581::drivebusy - cbm1581::drvcodebeg + cbm1581::drivecode)
dcodeselt1: .byte >(cbm1541::dinstall  - cbm1541::drvcodebeg41 + cbm1541::drivecode41)
            .byte >(cbm1571::drivebusy - cbm1571::drvcodebeg + cbm1571::drivecode71)
            .byte >(cbm1581::drivebusy - cbm1581::drvcodebeg + cbm1581::drivecode)
dcodeselt2: .byte <(cbm1541::drvprgend - cbm1541::drvcodeend41)
            .byte <(cbm1571::drvprgend - cbm1571::drivebusy)
            .byte <(cbm1581::drvprgend - cbm1581::drivebusy)
dcodeselt3: .byte <cbm1541::drivecode41
            .byte <cbm1571::drivecode71
            .byte <cbm1581::drivecode
dcodeselt4: .byte >cbm1541::drivecode41
            .byte >cbm1571::drivecode71
            .byte >cbm1581::drivecode
dcodeselt5: .byte >cbm1541::dinstall
            .byte >cbm1571::drivebusy
            .byte >cbm1581::drivebusy
dcodeselt6: .byte <cbm1541::dinstall
            .byte <cbm1571::drivebusy
            .byte <cbm1581::drivebusy
